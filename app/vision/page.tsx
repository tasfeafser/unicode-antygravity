...
export default function VisionPage() {
  return (
    <div className="min-h-screen p-6 md:p-20 relative z-10">
      <div className="max-w-4xl mx-auto rounded-3xl bg-white/[0.02] border border-white/10 p-8 md:p-12 relative overflow-hidden backdrop-blur-sm">
        ...
        <div className="relative z-10 font-serif">
          ...
          <div className="space-y-8 text-gray-300 leading-relaxed text-lg">
            <p className="italic text-gray-400 text-xl border-l-4 border-purple-500 pl-6 py-2">
            ...
            <p>
              Today, I am introducing a platform that is that bridge. This isn't just another 'AI chatbot.' This is a unified <strong className="text-white">Academic OS</strong> designed to take a student from 'Hello World' to 'Software Engineer.'
            </p>

            <div className="py-6 space-y-12">
              <section>
                <h4 className="text-xl font-medium text-white mb-3 flex items-center gap-3">
                  <span className="flex items-center justify-center w-8 h-8 rounded bg-purple-500/20 text-purple-400 text-sm">1</span> 
              ...
              <section>
                <h4 className="text-xl font-medium text-white mb-3 flex items-center gap-3">
                  <span className="flex items-center justify-center w-8 h-8 rounded bg-blue-500/20 text-blue-400 text-sm">2</span> 
              ...
              <section>
                <h4 className="text-xl font-medium text-white mb-3 flex items-center gap-3">
                  <span className="flex items-center justify-center w-8 h-8 rounded bg-green-500/20 text-green-400 text-sm">3</span> 
            ...
            <div className="mt-12 p-8 rounded-2xl bg-gradient-to-r from-purple-500/10 to-blue-500/10 border border-white/5 text-center">
